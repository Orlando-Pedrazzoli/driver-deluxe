          ...
          <div className='flex flex-col px-6 py-8 space-y-6 rounded-sm sm:p-8 lg:p-12 lg:w-1/2 xl:w-2/5 bg-gray-200 text-gray-900'>
            <div className='flex space-x-2 sm:space-x-4 mt-8'>
              ...
              <div className='space-y-2'>
                <p className='text-lg font-medium leadi'>Vibration Massage:</p>
                <p className='leadi'>
                  ...
                  maintain muscle health. Pain Relief and Reduced Inflammation,
                  ...
                  musculoskeletal pain. Relaxation and Stress Reduction,This
                  helps in improving mood and overall well-being. It also
