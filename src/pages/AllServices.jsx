      ...
      <div className='container mx-auto space-y-12'>
        <div className='flex flex-col overflow-hidden rounded-md shadow-sm lg:flex-row'>
          ...
          <div className='flex flex-col justify-center flex-1 p-6 dark:bg-gray-50'>
            ...
            <Link to='/services'>
              <button className='overflow-hidden relative flex justify-center items-center w-24 p-2 h-10 bg-black text-white border-none rounded-md text-sm font-bold cursor-pointer relative z-10 group'>
                Massages
              </button>
            </Link>
          </div>
