  ...
  return loading ? (
    ...
    <>
          ...
          <div className='flex flex-col px-6 py-8 space-y-6 rounded-sm sm:p-8 lg:p-12 lg:w-1/2 xl:w-2/5 bg-gray-200 text-gray-900'>
            <div className='flex space-x-2 sm:space-x-4 mt-8'>
              ...
              <div className='space-y-2'>
                ...
                <p className='leadi'>
                  Euromaster Portugal boasts a network consisting of more than
                  85 tire and mechanical specialist workshops, spread throughout
                  the country. Our goal is to always be close to you. In
                  addition to offering an exclusive service, our professionals
                  are experts in meeting various needs related to quick
                  mechanics for the perfect maintenance of your vehicle.
                </p>
      ...
      <h1 className='text-center font-semibold text-2xl mb-6'>
        Check all <span className='font-bold'> EUROMASTER SERVICES</span> on the
        map with
        <span className='text-purple-500 font-bold'> Purple ICON </span>
        <img
          src={purpleicon}
          alt='Icon'
