          ...
          <div className='flex flex-col px-6 py-8 space-y-6 rounded-sm sm:p-8 lg:p-12 lg:w-1/2 xl:w-2/5 bg-gray-200 text-gray-900'>
            <div className='flex space-x-2 sm:space-x-4 mt-8'>
              ...
              <div className='space-y-2'>
                <p className='text-lg font-medium leadi'>Norauto:</p>
                <p className='leadi'>
                  Norauto, a specialist in automotive equipment and maintenance,
                  offers you a wide range of tires from all brands,mechanical
                  parts, maintenance products, as well as quick wear maintenance
                  parts to meet all your car needs. Norauto also offers you a
                  wide range of services for your car maintenance: Official
                  Inspection, oil change, tire mounting and balancing, air
                  conditioning maintenance, and many more. With Norauto, you can
                  be sure to travel in total safety!
                </p>
